        ...
        <section>
          <div className="bg-green-300/10 px-2 py-4 flex justify-between items-center">
            <div className="relative">
              <div className="bg-[#C7EAD5] p-4 rounded-full">
                <User className="size-10" />
              </div>
              <div className="bg-green-700 w-fit p-1.5 rounded-full absolute left-12 bottom-0.5">
                <Pencil className="size-3 text-white" />
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <h1 className="font-bold">Gabriel Souza</h1>
              <h2 className="text-sm truncate w-36">
                gabrielsouza65115gmail.com
              </h2>
